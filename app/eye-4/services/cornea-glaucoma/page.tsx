        ...
        <div class="row">
            <div class="col-xl-8 col-lg-7">
                <div class="services-details-content">
                    <div class="services-details-image1">
                        <img src="/eye-4/assets/images/services/services-details-3.jpg" alt="Awesome Image">
                    ...
                    <div class="services-details-text2">
                        <div class="row">
                            <div class="col-xl-5">
                                <div class="img-box">
                                    <img src="/eye-4/assets/images/services/services-details-small.jpg" alt="Awesome Image">
                                </div>
                            </div>
                            <div class="col-xl-7">
                                <div class="text-box">
                                    <h3>Cornea & Glaucoma Benefits</h3>
            ...
            <div class="col-xl-4 col-lg-5">
                <div class="services-details-sidebar">
                    <div class="single-sidebar1">
                        ...
                        <div class="page-links">
                            <ul>
                                ...
                                <li class="active"><a href="/eye-4/services/cornea-glaucoma">Cornea & Glaucoma</a></li>
                    ...
                    <div class="single-sidebar2" style="background-image: url('/eye-4/assets/images/sidebar/single-sidebar2-bg.jpg')">
