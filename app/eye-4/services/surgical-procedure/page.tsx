            ...
            <div class="col-xl-8 col-lg-7">
                <div class="services-details-content">
                    <div class="services-details-image1">
                        <img src="/eye-4/assets/images/services/services-details-1.jpg" alt="Awesome Image">
                    ...
                    <div class="services-details-text2">
                        <div class="row">
                            ...
                            <div class="col-xl-7">
                                <div class="text-box">
                                    <h3>Surgical Procedure Benefits</h3>
                ...
                <div class="services-details-sidebar">
                    <div class="single-sidebar1">
                        ...
                        <div class="page-links">
                            <ul>
                                <li class="active"><a href="/eye-4/services/surgical-procedure">Surgical Procedure</a></li>
