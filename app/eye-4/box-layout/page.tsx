...
<section class="services-style1-area services-style1-instyle2">
    <div class="container">
        <div class="row">
            <div class="col-xl-12">
                <div class="top-title">
            ...
            <div class="col-xl-6">
                <div class="team-content-box">
                    ...
                    <div class="inner-content">
                        <div class="text-box">
                            <p>Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. sed do eiusmod tempor incididunt ut labore et Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et.</p>
                        </div>
                        <div class="offering-box">
                            <div class="img-holder">
                                <img src="/eye-4/assets/images/resources/offering.jpg" alt="Awesome Image">
                            </div>
                        ...
                        <div class="inner viewport">
                            <div class="overview">
                                ...
                                <div class="single-team-member wow animated fadeInUp" data-wow-delay="0.1s">
                                    <div class="img-holder">
                                        <div class="inner">
                                            <img src="/eye-4/assets/images/team/team-v1-1.jpg" alt="Awesome Image">
                                ...
                                <div class="single-team-member wow animated fadeInUp" data-wow-delay="0.1s">
                                    <div class="img-holder">
                                        <div class="inner">
                                            <img src="/eye-4/assets/images/team/team-v1-2.jpg" alt="Awesome Image">
                                            <div class="overlay-style-one bg2"></div>
                                        </div>
                                    </div>
                                    <div class="title-holder">
                                ...
                                <div class="single-team-member wow animated fadeInUp" data-wow-delay="0.1s">
                                    <div class="img-holder">
                                        <div class="inner">
                                            <img src="/eye-4/assets/images/team/team-v1-3.jpg" alt="Awesome Image">
                                            <div class="overlay-style-one bg2"></div>
                                        </div>
                                    </div>
                                    <div class="title-holder">
...
<section class="before-after-work-area">
    ...
    <div class="container">
        <div class="sec-title text-center">
            <h2><span>OptiLuxe</span> before & after work<br> slideshow</h2>
        </div>
        <div class="row">
            <div class="col-xl-12">
...
<section class="blog-style1-area graybg">
    <div class="container">
        <div class="row">
            <div class="col-xl-12">
                <div class="top-title">
        ...
        <div class="row">
            ...
            <div class="col-xl-4 col-lg-4">
                <div class="single-blog-style1 style1-instyle2 wow fadeInLeft" data-wow-delay="300ms" data-wow-duration="1500ms">
                    ...
                    <div class="text-holder">
                        <h3 class="blog-title"><a href="#">Protect your eyes from dust and disease. Get a better vision</a></h3>
                        <ul class="meta-info">
                            <li><span class="icon-user thm-clr"></span><a href="#">Admin</a></li>
                            <li><span class="icon-comments thm-clr"></span><a href="#">2 Comments</a></li>
                        </ul>
        ...
        <div class="row">
            ...
            <div class="col-xl-5">
                <div class="contact-image-box clearfix" data-aos="fade-left" data-aos-easing="linear" data-aos-duration="300">
                    <img src="/eye-4/assets/images/resources/contact-image.jpg" alt="Awesome Image">
                </div>    
            </div>
...
<section class="partner-style2-area" style="background-image: url('/eye-4/assets/images/parallax-background/partner-style2-area-bg.jpg')">
    <div class="container">
        <div class="row">
            <div class="col-xl-12">
