...
export default function AppointmentPage() {
  ...
  return (
    <div className="boxed_wrapper">
      ...
      <section className="breadcrumb-area" style={{ backgroundImage: "url('/eye-4/assets/images/breadcrumb/breadcrumb-1.jpg')" }}>
      ...
      <section className="emergency-contact-area" style={{ backgroundImage: "url('/eye-4/assets/images/parallax-background/emergency-contact-area-bg.jpg')" }}>
        <div className="container">
          <div className="row">
            <div className="col-xl-5">
