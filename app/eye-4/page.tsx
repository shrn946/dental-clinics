        ...
        <div class="row">
            ...
            <div class="col-xl-7">
                <div class="welcome-image-box">
                    <img src="/eye-4/assets/images/resources/welcome-1.jpg" alt="Awesome Image">
                    <div class="experience-box">
                        <h2>20</h2>
                        <h3>Years of<br> practicing</h3>    
                    </div>
                    <div class="image2">
                        <img src="/eye-4/assets/images/resources/welcome-2.jpg" alt="Awesome Image">
                    </div>
                </div>    
            </div>
            ...
            <div class="row">
                <div class="col-xl-5">
                    <div class="certified-content-box">
                        <div class="sec-title">
                            <h2><span>OptiLuxe</span> certified<br> & professional<br> eye clinic</h2>
                        </div>
                        <div class="text">
                ...
                <div class="col-xl-3">
                    <div class="certified-image-box1">
                        <img src="/eye-4/assets/images/resources/certified-image-1.jpg" alt="Awesome Image">
                    </div>        
                </div>
                <div class="col-xl-4">
                    <div class="certified-box clearfix">
                        <div class="icon-box">
                            <div class="eye-box"><img src="/eye-4/assets/images/icon/eye-2.png" alt="Eye Icon"></div>
                        </div>
                        <ul class="clearfix">
                            <li>
                                <img src="/eye-4/assets/images/resources/certificate-1.jpg" alt="Awesome Image">    
                            </li>
                            <li>
                                <img src="/eye-4/assets/images/resources/certificate-2.jpg" alt="Awesome Image">    
                            </li>
                            <li>
                                <img src="/eye-4/assets/images/resources/certificate-3.jpg" alt="Awesome Image">    
                            </li>
                            <li>
                                <img src="/eye-4/assets/images/resources/certificate-4.jpg" alt="Awesome Image">    
                            </li>
                        </ul>
                    </div>        
                </div>
        ...
        <div class="row">
            <div class="col-xl-5">
                <div class="choose-left-box clearfix">
                    <div class="video-holder-box clearfix">
                        <img src="/eye-4/assets/images/resources/video-gallery-bg.jpg" alt="">
                        <div class="icon">
                            <a class="video-popup" title="OptiLuxe Video Gallery" href="https://www.youtube.com/watch?v=p25gICT63ek">
            ...
            <div class="col-xl-7">
                <div class="choose-content-box">
                    <div class="sec-title">
                        <h2><span>OptiLuxe</span> why you should<br> choose our services</h2>
                    </div>
                    <div class="inner-content">
                                        ...
                                        <div class="tab active-tab" id="eye-treatment">
                                            <div class="choose-tab-content-box">
                                                ...
                                                <div class="bottom-content">
                                                    <div class="image-box">
                                                        <img src="/eye-4/assets/images/resources/choose-1.png" alt="Awesome Image">
                                                    </div>
                                                    <div class="text-box">
                                                        <ul>
                                                            <li>Nsectetur cing elit</li>
...
<section class="testimonial-style1-area">
    <div class="shape1 zoom-fade">
        <img src="/eye-4/assets/images/shape/shape-2.png" alt="Shape1">
    </div>
    <div class="shape2 float-bob">
        <img src="/eye-4/assets/images/shape/shape-3.png" alt="Shape2">
    </div>
    <div class="container">
        <div class="row">
            <div class="col-xl-12">
        ...
        <div class="row"> 
            <div class="col-xl-4 col-lg-4">
                ...
                <div class="single-testimonial-style1 text-center  wow fadeInUp" data-wow-delay="100ms" data-wow-duration="1500ms">
                    <div class="inner-content">
                        <div class="bg" style="background-image: url('/eye-4/assets/images/pattern/single-testimonial-style1-bg.png')"></div>
                        <div class="bg-overlay" style="background-image: url('/eye-4/assets/images/pattern/single-testimonial-style1-bg-overlay.png')"></div>
                        <div class="quote-icon">
                            <img class="main-icon" src="/eye-4/assets/images/icon/quote-1.png" alt="Quote Icon">
                            <div class="overlay-icon">
                                <img src="/eye-4/assets/images/icon/quote-2.png" alt="Quote Icon">    
                            </div>
                        </div>      
                        <div class="text-box">
                        ...
                        <div class="img-box">
                            <img src="/eye-4/assets/images/testimonial/tes-v1-1.png" alt="Awesome Image">
                        </div>
                    </div>
...
<section class="partner-area">
    <div class="layer-outer" style="background-image: url('/eye-4/assets/images/parallax-background/partner-area-bg.png')"></div>
    <div class="container">
        <div class="row">
            <div class="col-xl-12">
...
<section class="service-style2-area">
    <div class="layer-outer-shape paroller" style="background-image: url('/eye-4/assets/images/shape/service-style2-area-shape.png')"></div>
    <div class="container">
        <div class="row">
            <div class="col-xl-6">
            ...
            <div class="col-xl-6">
                <div class="service-style2-right">
                    <img src="/eye-4/assets/images/services/service-style2-right-img.jpg" alt="Awesome Image">
                </div>    
            </div>
        ...
        <div class="row">
            ...
            <div class="col-xl-4 col-lg-4">
                <div class="single-blog-style1 wow fadeInLeft" data-wow-delay="100ms" data-wow-duration="1500ms">
                    ...
                    <div class="text-holder">
                        <h3 class="blog-title"><a href="#">Now you can see the better future</a></h3>
                        <ul class="meta-info">
            ...
            <div class="col-xl-4 col-lg-4">
                <div class="single-blog-style1 wow fadeInLeft" data-wow-delay="200ms" data-wow-duration="1500ms">
                    ...
                    <div class="text-holder">
                        <h3 class="blog-title"><a href="#">Protect your eyes from dust and disease</a></h3>
                        <ul class="meta-info">
                            <li><span class="icon-user thm-clr"></span><a href="#">Admin</a></li>
                            <li><span class="icon-comments thm-clr"></span><a href="#">2 Comments</a></li>
                        </ul>
            ...
            <div class="col-xl-4 col-lg-4">
                <div class="single-blog-style1 wow fadeInLeft" data-wow-delay="300ms" data-wow-duration="1500ms">
                    <div class="img-holder">
                        <div class="inner">
                            <img src="/eye-4/assets/images/blog/blog-v1-3.jpg" alt="Awesome Image">
                        </div>
                        <div class="date-box">
                            <h5>12 June</h5>
                        </div>
                    ...
                    <div class="text-holder">
                        <h3 class="blog-title"><a href="#">We're ready to enhance your vision</a></h3>
                        <ul class="meta-info">
                            <li><span class="icon-user thm-clr"></span><a href="#">Admin</a></li>
                            <li><span class="icon-comments thm-clr"></span><a href="#">2 Comments</a></li>
                        </ul>
...
<section class="slogan-style2-area">
    <div class="icon-holder">
        <img src="/eye-4/assets/images/icon/icon.png" alt="Icon">
    </div>
    <div class="outer-container">
        <div class="row">
            ...
            <div class="col-xl-6">
                <div class="slogan-single-box">
                    <div class="img-holder">
                        <div class="inner">
                            <img src="/eye-4/assets/images/resources/slogan-single-1.jpg" alt="">
                        </div>
                ...
                <div class="slogan-single-box">
                    <div class="img-holder">
                        <div class="inner gray-bg">
                            <img src="/eye-4/assets/images/resources/slogan-single-2.jpg" alt="">
                        </div>
                        <div class="overlay-content">
