...
<footer class="footer-area">
    <div class="layer-outer">
        <div class="shape1 zoom-fade">
            <img src="/eye-4/assets/images/shape/footer-shape-1.png" alt="Shape1">
        </div>
        <div class="shape2" data-aos="fade-up" data-aos-easing="linear" data-aos-duration="2000" 
        style="background-image: url('/eye-4/assets/images/shape/footer-shape-2.png')">     
        </div>    
    </div>
    <div class="footer">
        <div class="container">
                    ...
                    <div class="single-footer-widget marbtm">
                        <div class="our-company-info">
                            <div class="footer-logo">
                                <a href="/eye-4" style="display: flex; align-items: center; gap: 12px; text-decoration: none;"><span class="logo-text">Opti<span>Luxe</span></span></a>    
                            </div>
                            <div class="text">
                        ...
                        <ul class="footer-news-links clearfix">
                            <li class="single-news">
                                <div class="img-holder">
                                    <img src="/eye-4/assets/images/footer/footer-news-1.jpg" alt="Awesome Image">
                            ...
                            <li class="single-news">
                                <div class="img-holder">
                                    <img src="/eye-4/assets/images/footer/footer-news-2.jpg" alt="Awesome Image">
                                    <div class="overlay-content">
                                        <a href="#"><i class="fa fa-link" aria-hidden="true"></i></a>
                                    </div>
                                </div>
        ...
        <div class="container">
            <div class="outer-box">
                <div class="copyright-text text-center">
                    <p>&copy; Copyright 2020 by <a href="#">optiluxe</a></p>
                </div>
            </div>    
        </div>    
    </div>
