                        ...
                        <div class="inner viewport">
                            <div class="overview">
                                ...
                                <div class="single-team-member wow animated fadeInUp" data-wow-delay="0.1s">
                                    <div class="img-holder">
                                        <div class="inner">
                                            <img src="/eye-1/assets/images/team/team-v1-1.jpg" alt="Awesome Image">
                                ...
                                <div class="single-team-member wow animated fadeInUp" data-wow-delay="0.1s">
                                    <div class="img-holder">
                                        <div class="inner">
                                            <img src="/eye-1/assets/images/team/team-v1-2.jpg" alt="Awesome Image">
                                            <div class="overlay-style-one bg2"></div>
                                        </div>
                                    </div>
                                    <div class="title-holder">
                                ...
                                <div class="single-team-member wow animated fadeInUp" data-wow-delay="0.1s">
                                    <div class="img-holder">
                                        <div class="inner">
                                            <img src="/eye-1/assets/images/team/team-v1-3.jpg" alt="Awesome Image">
                                            <div class="overlay-style-one bg2"></div>
                                        </div>
                                    </div>
                                    <div class="title-holder">
...
<section class="before-after-work-area">
    ...
    <div class="container">
        <div class="sec-title text-center">
            <h2><span>Oktilcal</span> before & after work<br> slideshow</h2>
        </div>
        <div class="row">
            <div class="col-xl-12">
