                    ...
                    <div class="row">
                        <div class="col-xl-5">
                            <div class="single-image-box image1">
                                <img src="/eye-1/assets/images/about/about-1.jpg" alt="Awesome Image">
                            </div>
                        </div>
                        <div class="col-xl-3 col-lg-6 col-md-12">
                            <div class="single-image-box image2">
                                <img src="/eye-1/assets/images/about/about-2.jpg" alt="Awesome Image">
                            </div>
                        </div>
                        <div class="col-xl-4 col-lg-6 col-md-12">
                            <div class="single-image-box">
                                <img src="/eye-1/assets/images/about/about-3.jpg" alt="Awesome Image">
            ...
            <div class="col-xl-12">
                <div class="partner-box-style3">
                    ...
                    <div class="single-partner-logo-box-style3">
                        <a href="#"><img src="/eye-1/assets/images/brand/brand-v2-1.png" alt="Awesome Image"></a>
                    </div>
                    <!--End Single Partner Logo Box Style3-->
                    <!--Start Single Partner Logo Box Style3-->
                    <div class="single-partner-logo-box-style3">
                        <a href="#"><img src="/eye-1/assets/images/brand/brand-v2-2.png" alt="Awesome Image"></a>
                    </div>
                    <!--End Single Partner Logo Box Style3-->
                    <!--Start Single Partner Logo Box Style3-->
                    <div class="single-partner-logo-box-style3">
                        <a href="#"><img src="/eye-1/assets/images/brand/brand-v2-3.png" alt="Awesome Image"></a>
                    </div>
                    <!--End Single Partner Logo Box Style3-->
                    <!--Start Single Partner Logo Box Style3-->
                    <div class="single-partner-logo-box-style3">
                        <a href="#"><img src="/eye-1/assets/images/brand/brand-v2-4.png" alt="Awesome Image"></a>
                    </div>
                    <!--End Single Partner Logo Box Style3-->
                    <!--Start Single Partner Logo Box Style3-->
                    <div class="single-partner-logo-box-style3">
                        <a href="#"><img src="/eye-1/assets/images/brand/brand-v2-5.png" alt="Awesome Image"></a>
                    </div>
                    <!--End Single Partner Logo Box Style3-->
                </div>
            </div>
        ...
        <div class="row">
            ...
            <div class="col-xl-4 col-lg-4">
                <div class="single-team-member wow animated fadeInUp" data-wow-delay="0.1s">
                    <div class="img-holder">
                        <div class="inner">
                            <img src="/eye-1/assets/images/team/team-v2-1.jpg" alt="Awesome Image">
            ...
            <div class="col-xl-4 col-lg-4">
                <div class="single-team-member wow animated fadeInUp" data-wow-delay="0.1s">
                    <div class="img-holder">
                        <div class="inner">
                            <img src="/eye-1/assets/images/team/team-v2-2.jpg" alt="Awesome Image">
                            <div class="overlay-style-one bg2"></div>
                        </div>
                    </div>
                    <div class="title-holder">
            ...
            <div class="col-xl-4 col-lg-4">
                <div class="single-team-member wow animated fadeInUp" data-wow-delay="0.1s">
                    <div class="img-holder">
                        <div class="inner">
                            <img src="/eye-1/assets/images/team/team-v2-3.jpg" alt="Awesome Image">
                            <div class="overlay-style-one bg2"></div>
                        </div>
                    </div>
                    <div class="title-holder">
        ...
        <div class="row">
            ...
            <div class="col-xl-7">
                <div class="welcome-image-box style2">
                    <img src="/eye-1/assets/images/resources/welcome-3.jpg" alt="Awesome Image">
