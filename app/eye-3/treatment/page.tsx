        ...
        <div class="row clearfix">
            ...
            <div class="col-lg-4 col-md-6 col-sm-12 service-block">
                <div class="service-block-one wow fadeInUp animated" data-wow-delay="00ms" data-wow-duration="1500ms">
                    <div class="inner-box">
                        <figure class="image-box">
                            <img src="/eye-3/assets/images/service/service-5.jpg" alt="">
                            <a href="/eye-3/surgical-procedures"><i class="fas fa-link"></i></a>
                        </figure>
                        <div class="lower-content">
                            <div class="icon-box"><i class="icon-21"></i></div>
                            <h3><a href="/eye-3/vision-correction">Vision Correction</a></h3>
                            <p class="p_relative d_block">Lorem ipsum dolor amet consectur tempor adicing elit sed do usmod tempor incidunt enim minim veniam.</p>
                            <div class="link p_relative d_block"><a href="/eye-3/vision-correction">Read More</a></div>
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-lg-4 col-md-6 col-sm-12 service-block">
                <div class="service-block-one wow fadeInUp animated" data-wow-delay="300ms" data-wow-duration="1500ms">
                    <div class="inner-box">
                        <figure class="image-box">
                            <img src="/eye-3/assets/images/service/service-6.jpg" alt="">
                            <a href="/eye-3/paeditaric-ophthalmology"><i class="fas fa-link"></i></a>
                        </figure>
                        <div class="lower-content">
                            <div class="icon-box"><i class="icon-20"></i></div>
                            <h3><a href="/eye-3/laser-surgery">Laser Eye Surgery</a></h3>
                            <p class="p_relative d_block">Lorem ipsum dolor amet consectur tempor adicing elit sed do usmod tempor incidunt enim minim veniam.</p>
                            <div class="link p_relative d_block"><a href="/eye-3/laser-surgery">Read More</a></div>
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-lg-4 col-md-6 col-sm-12 service-block">
                <div class="service-block-one wow fadeInUp animated" data-wow-delay="600ms" data-wow-duration="1500ms">
                    <div class="inner-box">
                        <figure class="image-box">
                            <img src="/eye-3/assets/images/service/service-7.jpg" alt="">
                            <a href="/eye-3/lenses-transitions"><i class="fas fa-link"></i></a>
                        </figure>
                        <div class="lower-content">
                            <div class="icon-box"><i class="icon-22"></i></div>
                            <h3><a href="/eye-3/contact-lens">Contact Lens</a></h3>
                            <p class="p_relative d_block">Lorem ipsum dolor amet consectur tempor adicing elit sed do usmod tempor incidunt enim minim veniam.</p>
                            <div class="link p_relative d_block"><a href="/eye-3/contact-lens">Read More</a></div>
                        </div>
                    </div>
                </div>
            </div>
