    ...
    <div class="auto-container">
        <div class="row clearfix">
            <div class="col-lg-5 col-md-12 col-sm-12 image-column">
                <figure class="image-box"><img src="/eye-3/assets/images/team/team-15.jpg" alt=""></figure>
            </div>
            <div class="col-lg-7 col-md-12 col-sm-12 content-column">
                <div class="team-details-content">
                    <div class="team-info">
                        <h2>Dr.Robert De Niro</h2>
                        <span class="designation">Glaucoma Specialist</span>
                        <p>Lorem ipsum dolor sit amet consectetur adipisicing elit sed do eius mod tempor incidid unt labore et dolore magna aliqua. enim ad minim veniam quis nostrud exercitation ullamco laboris nisi aliquip commodo consequat.</p>
                        <ul class="list clearfix">
                            <li><span>Occupation:</span>Ophthalmology and Ophthalmologists</li>
                            <li><span>Experience:</span>20 Years</li>
                            <li><span>Skills:</span>Working with both children and adults</li>
                            <li><span>Certificates:</span>National specialist register in psyhology</li>
                            <li><span>Education::</span>MBBS, MMS</li>
                            <li><span>Location:</span>380 Albert St, Melborne</li>
                            <li><span>Phone:</span><a href="tel:123045615523">+1 (230)-456-155-23</a></li>
                            <li><span>Email:</span><a href="mailto:info@example.com">info@example.com</a></li>
                            <li><span>Website:</span><a href="/eye-3/team-details">www.robertniro.com</a></li>
                        </ul>
                        <ul class="social-link clearfix">
                            <li><a href="/eye-3/team-details"><i class="fab fa-facebook-f"></i></a></li>
                            <li><a href="/eye-3/team-details"><i class="fab fa-twitter"></i></a></li>
                            <li><a href="/eye-3/team-details"><i class="fab fa-google-plus-g"></i></a></li>
                        </ul>
                    </div>
                    ...
                    <div class="contact-box">
                        ...
                        <div class="form-inner">
                            <form action="https://z.commonsupport.com/php/optcare/team-details.php" method="post">
                                <div class="row clearfix">
