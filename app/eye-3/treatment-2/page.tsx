            ...
            <div class="col-lg-3 col-md-6 col-sm-12 service-block">
                <div class="service-block-two wow fadeInUp animated" data-wow-delay="00ms" data-wow-duration="1500ms">
                    <div class="inner-box">
                        ...
                        <h3><a href="/eye-3/vision-correction">Vision <br />Correction</a></h3>
                        <p>Lorem ipsum dolor amet cons ectur tempor adicing elit sed do usmod tempor.</p>
                        <div class="link-text"><a href="/eye-3/vision-correction">Read More</a></div>
                    </div>
                </div>
            </div>
            <div class="col-lg-3 col-md-6 col-sm-12 service-block">
                <div class="service-block-two wow fadeInUp animated" data-wow-delay="200ms" data-wow-duration="1500ms">
                    <div class="inner-box">
                        ...
                        <h3><a href="/eye-3/contact-lens">Contact <br />Lens</a></h3>
                        <p>Lorem ipsum dolor amet cons ectur tempor adicing elit sed do usmod tempor.</p>
                        <div class="link-text"><a href="/eye-3/contact-lens">Read More</a></div>
                    </div>
                </div>
            </div>
            <div class="col-lg-3 col-md-6 col-sm-12 service-block">
                <div class="service-block-two wow fadeInUp animated" data-wow-delay="400ms" data-wow-duration="1500ms">
                    <div class="inner-box">
                        ...
                        <h3><a href="/eye-3/diabetic-retinopathy">Inherited <br />Retinal Diseases</a></h3>
                        <p>Lorem ipsum dolor amet cons ectur tempor adicing elit sed do usmod tempor.</p>
                        <div class="link-text"><a href="/eye-3/diabetic-retinopathy">Read More</a></div>
                    </div>
                </div>
            </div>
            <div class="col-lg-3 col-md-6 col-sm-12 service-block">
                <div class="service-block-two wow fadeInUp animated" data-wow-delay="600ms" data-wow-duration="1500ms">
                    <div class="inner-box">
                        ...
                        <h3><a href="/eye-3/diabetic-retinopathy">Diabetic <br />Retinopathy</a></h3>
                        <p>Lorem ipsum dolor amet cons ectur tempor adicing elit sed do usmod tempor.</p>
                        <div class="link-text"><a href="/eye-3/diabetic-retinopathy">Read More</a></div>
                    </div>
                </div>
