...
<section class="page-title">
    ...
    <div class="auto-container">
        <div class="content-box">
            <h1>Paeditaric Ophthalmology</h1>
            <ul class="bread-crumb clearfix">
                <li><a href="/eye-3/home-2">Home</a></li>
                <li>Paeditaric Ophthalmology</li>
            </ul>
        </div>
    </div>
</section>
        ...
        <div class="row clearfix">
            <div class="col-lg-4 col-md-12 col-sm-12 sidebar-side">
                <div class="service-sidebar mr_40">
                    <div class="text">
                        <h3>Categories</h3>
                        <p>Excepteur sint ocaecat cupidatat exo proident sunt culpa.</p>
                    </div>
                    <ul class="category-list clearfix">
                        <li><a href="/eye-3/treatment">All Treatment</a></li>
                        <li><a href="/eye-3/surgical-procedures">Surgical Procedures</a></li>
                        <li><a href="/eye-3/paeditaric-ophthalmology" class="current">Paeditaric Ophthalmology</a></li>
                        <li><a href="/eye-3/lenses-transitions">Lenses Transitions</a></li>
                        <li><a href="/eye-3/laser-surgery">Laser Eye Surgery</a></li>
                        <li><a href="/eye-3/vision-correction">Vision Correction</a></li>
                        <li><a href="/eye-3/contact-lens">Contact Lens</a></li>
            ...
            <div class="col-lg-8 col-md-12 col-sm-12 content-side">
                <div class="service-details-content">
                    <div class="content-one">
                        <div class="text">
                            <h2>Paeditaric Ophthalmology</h2>
                            <p>Lorem ipsum dolor sit amet consectur adipisicing elit sed do eiusmod tempor incidunt labore dolore magna aliqua enim minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. duis aute irure dolor in reprehend erit in voluptate velit esse cillum dolore fugiat nulla pariatur. Excepteur sint occaecat cupid atat non proident sunt in culpa qui officia deserunt mollit anim id est laborum.</p>
                            <p>Sed perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium totam rem aper i am eaque ipsa quae ab illo inventore veritatis et quasi architecto beatae vitae dicta sunt explicabo. Nemo enim ipsam voluptatem quia voluptas sit aspernatur aut odit aut fugit, sed quia consequuntur magni dolores eos qui ratione voluptatem sequi nesciunt Neque porro quisquam est qui dolorem ipsum quia dolor sit amet consectetur adipisci velit sed quia non numquam eius mod</p>
                        </div>
                        <figure class="image-box"><img src="/eye-3/assets/images/service/service-10.jpg" alt=""></figure>
                    </div>
                    <div class="content-two">
                        <div class="text">
                            <h3>Vision screenings use inadequate testing equipment.</h3>
                            <p>Lorem ipsum dolor sit amet consectur adipisicing elit sed do eiusmod tempor incidunt labore dolore magna aliqua enim minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. duis aute irure dolor in reprehend erit in voluptate velit esse cillum dolore fugiat nulla pariatur. Excepteur sint occaecat cupid atat non proident sunt in culpa qui officia deserunt mollit anim id est laborum.</p>
                            <p>Sed perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium totam rem aper i am eaque ipsa quae ab illo inventore veritatis et quasi architecto beatae vitae dicta sunt explicabo. Nemo enim ipsam voluptatem quia voluptas sit aspernatur aut odit aut fugit, sed quia consequuntur magni dolores eos qui ratione voluptatem sequi nesciunt Neque porro quisquam est qui dolorem ipsum quia dolor sit amet consectetur adipisci velit sed quia non numquam eius mod</p>
                        </div>
                    </div>
                    <div class="content-three">
                        <div class="row clearfix">
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-12 image-column">
                                <figure class="image-box mt_5"><img src="/eye-3/assets/images/service/service-9.jpg" alt=""></figure>
                            </div>
                        </div>
                    </div>
                    <div class="content-four">
                        <div class="text">
                            <h3>The benefits of surgical procedures</h3>
                            <p>Perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium totam rem aper i am eaque ipsa quae ab illo inventore veritatis et quasi architecto beatae vitae dicta sunt explicabo. Nemo enim ipsam voluptatem quia voluptas.</p>
                            <ul class="list-style-one clearfix">
                                <li>This is an evaluation of the whites of your eyes, the iris and pupil</li>
                                <li> Your doctor will test your vision with different lenses to determine if glasses or contact lenses can improve your vision.</li>
                                <li>Retina and optic nerve while your eyes are dilated.</li>
                            </ul>
                        </div>
                    </div>
                </div>
