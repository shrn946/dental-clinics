...
<section class="page-title">
    ...
    <div class="auto-container">
        <div class="content-box">
            <h1>Doctors 4 Column</h1>
            <ul class="bread-crumb clearfix">
                <li><a href="/eye-3/home-2">Home</a></li>
                <li>Doctors 4 Column</li>
            </ul>
        </div>
    </div>
</section>
...
<!-- team-style-two -->
<section class="team-style-two team-page-2">
    <div class="auto-container">
        <div class="row clearfix">
            ...
            <div class="col-lg-3 col-md-6 col-sm-12 team-block">
                <div class="team-block-two wow fadeInUp animated animated" data-wow-delay="00ms" data-wow-duration="1500ms">
                    <div class="inner-box">
                        <figure class="image-box"><img src="/eye-3/assets/images/team/team-11.jpg" alt=""></figure>
                        <div class="lower-content p_relative d_block">
                            <div class="share-box p_absolute">
                                <a href="/eye-3/home-2" class="share-icon fs_14 d_iblock"><i class="icon-37"></i></a>
                                <ul class="share-links p_absolute clearfix">
                            ...
                            <h3><a href="/eye-3/team-details">Dr.Robert De Niro</a></h3>
                            <span class="designation">Glaucoma</span>
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-lg-3 col-md-6 col-sm-12 team-block">
                <div class="team-block-two wow fadeInUp animated animated" data-wow-delay="200ms" data-wow-duration="1500ms">
                    <div class="inner-box">
                        <figure class="image-box"><img src="/eye-3/assets/images/team/team-12.jpg" alt=""></figure>
                        <div class="lower-content p_relative d_block">
                            <div class="share-box p_absolute">
                                <a href="/eye-3/home-2" class="share-icon fs_14 d_iblock"><i class="icon-37"></i></a>
                                <ul class="share-links p_absolute clearfix">
                            ...
                            <h3><a href="/eye-3/team-details">Dr.Mel Gibson</a></h3>
                            <span class="designation">Laboratory</span>
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-lg-3 col-md-6 col-sm-12 team-block">
                <div class="team-block-two wow fadeInUp animated animated" data-wow-delay="400ms" data-wow-duration="1500ms">
                    <div class="inner-box">
                        <figure class="image-box"><img src="/eye-3/assets/images/team/team-13.jpg" alt=""></figure>
                        <div class="lower-content p_relative d_block">
                            <div class="share-box p_absolute">
                                <a href="/eye-3/home-2" class="share-icon fs_14 d_iblock"><i class="icon-37"></i></a>
                                <ul class="share-links p_absolute clearfix">
                            ...
                            <h3><a href="/eye-3/team-details">Dr.Samuel Jackson</a></h3>
                            <span class="designation">Optegra eye</span>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-lg-3 col-md-6 col-sm-12 team-block">
                <div class="team-block-two wow fadeInUp animated animated" data-wow-delay="600ms" data-wow-duration="1500ms">
                    <div class="inner-box">
                        <figure class="image-box"><img src="/eye-3/assets/images/team/team-14.jpg" alt=""></figure>
                        <div class="lower-content p_relative d_block">
                            <div class="share-box p_absolute">
                                <a href="/eye-3/home-2" class="share-icon fs_14 d_iblock"><i class="icon-37"></i></a>
                                <ul class="share-links p_absolute clearfix">
                            ...
                            <h3><a href="/eye-3/team-details">Dr.Kevin Costner</a></h3>
                            <span class="designation">Lens replacement</span>
                        </div>
                    </div>
                </div>
