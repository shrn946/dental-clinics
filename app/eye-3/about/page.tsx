...
<section class="chooseus-style-two about-page p_relative">
    <div class="shape-3 p_absolute t_0 r_0" style="background-image: url('/eye-3/assets/images/shape/shape-51.png);"></div>
    <div class="shape-2" style="background-image: url('/eye-3/assets/images/shape/shape-21.png);"></div>
    <div class="video-column" style="background-image: url('/eye-3/assets/images/background/video-bg-3.jpg);">
