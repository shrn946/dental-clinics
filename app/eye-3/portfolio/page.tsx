    ...
    <div class="auto-container">
        <div class="sortable-masonry">
            ...
            <div class="items-container row clearfix">
                <div class="col-lg-4 col-md-6 col-sm-12 masonry-item small-column all product paeditaric lenses">
                    <div class="project-block-one">
                        <div class="inner-box">
                            <figure class="image-box"><img src="/eye-3/assets/images/project/project-10.jpg" alt=""></figure>
                            <div class="view-btn"><a href="/eye-3/assets/images/project/project-10.jpg" class="lightbox-image" data-fancybox="gallery"><i class="icon-33"></i></a></div>
                            <div class="text">
                ...
                <div class="col-lg-4 col-md-6 col-sm-12 masonry-item small-column all surgical lenses equipment">
                    <div class="project-block-one">
                        <div class="inner-box">
                            <figure class="image-box"><img src="/eye-3/assets/images/project/project-11.jpg" alt=""></figure>
                            <div class="view-btn"><a href="/eye-3/assets/images/project/project-11.jpg" class="lightbox-image" data-fancybox="gallery"><i class="icon-33"></i></a></div>
                            <div class="text">
                                <h3><a href="/eye-3/home-2">Living Modern Design</a></h3>
                                <span>Residential</span>
                            </div>
                ...
                <div class="col-lg-4 col-md-6 col-sm-12 masonry-item small-column all product paeditaric equipment">
                    <div class="project-block-one">
                        <div class="inner-box">
                            <figure class="image-box"><img src="/eye-3/assets/images/project/project-12.jpg" alt=""></figure>
                            <div class="view-btn"><a href="/eye-3/assets/images/project/project-12.jpg" class="lightbox-image" data-fancybox="gallery"><i class="icon-33"></i></a></div>
                            <div class="text">
                                <h3><a href="/eye-3/home-2">Living Modern Design</a></h3>
                                <span>Residential</span>
                            </div>
                ...
                <div class="col-lg-4 col-md-6 col-sm-12 masonry-item small-column all surgical paeditaric lenses">
                    <div class="project-block-one">
                        <div class="inner-box">
                            <figure class="image-box"><img src="/eye-3/assets/images/project/project-13.jpg" alt=""></figure>
                            <div class="view-btn"><a href="/eye-3/assets/images/project/project-13.jpg" class="lightbox-image" data-fancybox="gallery"><i class="icon-33"></i></a></div>
                            <div class="text">
                                <h3><a href="/eye-3/home-2">Living Modern Design</a></h3>
                                <span>Residential</span>
                            </div>
                ...
                <div class="col-lg-4 col-md-6 col-sm-12 masonry-item small-column all lenses paeditaric equipment">
                    <div class="project-block-one">
                        <div class="inner-box">
                            <figure class="image-box"><img src="/eye-3/assets/images/project/project-14.jpg" alt=""></figure>
                            <div class="view-btn"><a href="/eye-3/assets/images/project/project-14.jpg" class="lightbox-image" data-fancybox="gallery"><i class="icon-33"></i></a></div>
                            <div class="text">
                                <h3><a href="/eye-3/home-2">Living Modern Design</a></h3>
                                <span>Residential</span>
                            </div>
                ...
                <div class="col-lg-4 col-md-6 col-sm-12 masonry-item small-column all surgical lenses equipment">
                    <div class="project-block-one">
                        <div class="inner-box">
                            <figure class="image-box"><img src="/eye-3/assets/images/project/project-15.jpg" alt=""></figure>
                            <div class="view-btn"><a href="/eye-3/assets/images/project/project-15.jpg" class="lightbox-image" data-fancybox="gallery"><i class="icon-33"></i></a></div>
                            <div class="text">
                                <h3><a href="/eye-3/home-2">Living Modern Design</a></h3>
                                <span>Residential</span>
                            </div>
