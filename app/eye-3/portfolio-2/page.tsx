        ...
        <div class="sortable-masonry">
            <div class="filters mb_50">
                <ul class="filter-tabs filter-btns clearfix centred">
                    ...
                    <li class="filter" data-role="button" data-filter=".surgical">Surgical</li>
                    <li class="filter" data-role="button" data-filter=".paeditaric">Paeditaric</li>
                    <li class="filter" data-role="button" data-filter=".lenses">Lenses</li>
                    <li class="filter" data-role="button" data-filter=".equipment">Equipment</li>
                </ul>
            </div>
            <div class="items-container clearfix">
                <div class="masonry-item small-column all product paeditaric lenses">
                    <div class="project-block-one">
                        <div class="inner-box">
                            <figure class="image-box"><img src="/eye-3/assets/images/project/project-16.jpg" alt=""></figure>
                            <div class="view-btn"><a href="/eye-3/assets/images/project/project-16.jpg" class="lightbox-image" data-fancybox="gallery"><i class="icon-33"></i></a></div>
                            <div class="text">
                ...
                <div class="masonry-item small-column all surgical lenses equipment">
                    <div class="project-block-one">
                        <div class="inner-box">
                            <figure class="image-box"><img src="/eye-3/assets/images/project/project-17.jpg" alt=""></figure>
                            <div class="view-btn"><a href="/eye-3/assets/images/project/project-17.jpg" class="lightbox-image" data-fancybox="gallery"><i class="icon-33"></i></a></div>
                            <div class="text">
                                <h3><a href="/eye-3/home-2">Living Modern Design</a></h3>
                                <span>Residential</span>
                            </div>
                ...
                <div class="masonry-item small-column all product paeditaric equipment">
                    <div class="project-block-one">
                        <div class="inner-box">
                            <figure class="image-box"><img src="/eye-3/assets/images/project/project-18.jpg" alt=""></figure>
                            <div class="view-btn"><a href="/eye-3/assets/images/project/project-18.jpg" class="lightbox-image" data-fancybox="gallery"><i class="icon-33"></i></a></div>
                            <div class="text">
                                <h3><a href="/eye-3/home-2">Living Modern Design</a></h3>
                                <span>Residential</span>
                            </div>
                ...
                <div class="masonry-item small-column all surgical paeditaric lenses">
                    <div class="project-block-one">
                        <div class="inner-box">
                            <figure class="image-box"><img src="/eye-3/assets/images/project/project-19.jpg" alt=""></figure>
                            <div class="view-btn"><a href="/eye-3/assets/images/project/project-19.jpg" class="lightbox-image" data-fancybox="gallery"><i class="icon-33"></i></a></div>
                            <div class="text">
                                <h3><a href="/eye-3/home-2">Living Modern Design</a></h3>
                                <span>Residential</span>
                            </div>
                ...
                <div class="masonry-item small-column all lenses paeditaric equipment">
                    <div class="project-block-one">
                        <div class="inner-box">
                            <figure class="image-box"><img src="/eye-3/assets/images/project/project-20.jpg" alt=""></figure>
                            <div class="view-btn"><a href="/eye-3/assets/images/project/project-20.jpg" class="lightbox-image" data-fancybox="gallery"><i class="icon-33"></i></a></div>
                            <div class="text">
                                <h3><a href="/eye-3/home-2">Living Modern Design</a></h3>
                                <span>Residential</span>
                            </div>
                ...
                <div class="masonry-item small-column all surgical lenses equipment">
                    <div class="project-block-one">
                        <div class="inner-box">
                            <figure class="image-box"><img src="/eye-3/assets/images/project/project-21.jpg" alt=""></figure>
                            <div class="view-btn"><a href="/eye-3/assets/images/project/project-21.jpg" class="lightbox-image" data-fancybox="gallery"><i class="icon-33"></i></a></div>
                            <div class="text">
                                <h3><a href="/eye-3/home-2">Living Modern Design</a></h3>
                                <span>Residential</span>
                            </div>
                ...
                <div class="masonry-item small-column all product paeditaric equipment">
                    <div class="project-block-one">
                        <div class="inner-box">
                            <figure class="image-box"><img src="/eye-3/assets/images/project/project-22.jpg" alt=""></figure>
                            <div class="view-btn"><a href="/eye-3/assets/images/project/project-22.jpg" class="lightbox-image" data-fancybox="gallery"><i class="icon-33"></i></a></div>
                            <div class="text">
                                <h3><a href="/eye-3/home-2">Living Modern Design</a></h3>
                                <span>Residential</span>
                            </div>
                ...
                <div class="masonry-item small-column all surgical paeditaric lenses">
                    <div class="project-block-one">
                        <div class="inner-box">
                            <figure class="image-box"><img src="/eye-3/assets/images/project/project-23.jpg" alt=""></figure>
                            <div class="view-btn"><a href="/eye-3/assets/images/project/project-23.jpg" class="lightbox-image" data-fancybox="gallery"><i class="icon-33"></i></a></div>
                            <div class="text">
                                <h3><a href="/eye-3/home-2">Living Modern Design</a></h3>
                                <span>Residential</span>
                            </div>
                ...
                <div class="masonry-item small-column all lenses paeditaric equipment">
                    <div class="project-block-one">
                        <div class="inner-box">
                            <figure class="image-box"><img src="/eye-3/assets/images/project/project-24.jpg" alt=""></figure>
                            <div class="view-btn"><a href="/eye-3/assets/images/project/project-24.jpg" class="lightbox-image" data-fancybox="gallery"><i class="icon-33"></i></a></div>
                            <div class="text">
                                <h3><a href="/eye-3/home-2">Living Modern Design</a></h3>
                                <span>Residential</span>
                            </div>
                ...
                <div class="masonry-item small-column all surgical lenses equipment">
                    <div class="project-block-one">
                        <div class="inner-box">
                            <figure class="image-box"><img src="/eye-3/assets/images/project/project-25.jpg" alt=""></figure>
                            <div class="view-btn"><a href="/eye-3/assets/images/project/project-25.jpg" class="lightbox-image" data-fancybox="gallery"><i class="icon-33"></i></a></div>
                            <div class="text">
                                <h3><a href="/eye-3/home-2">Living Modern Design</a></h3>
                                <span>Residential</span>
                            </div>
