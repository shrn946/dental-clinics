						...
						<div class="collapse navbar-collapse for-mobile-menu" id="navbarSupportedContent">
							<ul class="navbar-nav m-auto">
								...
								<li class="nav-item">
									...
									<ul class="dropdown-menu">
										<li class="nav-item">
											<a href="/dental-7/products" class="nav-link active">Products Page</a>
										</li>
										<li class="nav-item">
				...
				<div class="product-result">
					<div class="row align-items-center">
						<div class="col-lg-4 col-md-4">
							<p>Showing <Span>09</Span> results</p>
						</div>
								...
								<div class="col-lg-6">
									<form>
										<div class="form-floating">
											<input type="text" class="form-control" id="searchHere" placeholder="Search Here">
				...
				<div class="row justify-content-center">
					<div class="col-lg-4 col-sm-6">
						<div class="main-product-item">
							<div class="product-img">
								...
								<a href="/dental-7/product-cart" class="main-btn">
					...
					<div class="col-lg-4 col-sm-6">
						<div class="main-product-item">
							...
							<div class="main-product-content">
								...
								<span><del>150.00</del> $100.00</span>
								<ul>
									<li>
										<i class="icofont-star"></i>
									</li>
					...
					<div class="col-lg-4 col-sm-6">
						<div class="main-product-item">
							<div class="product-img">
								<a href="#">
									<img src="/dental-7/assets/images/products/product-6.jpg" alt="Image">
								</a>
							...
							<div class="main-product-content">
								...
								<span><del>700.00</del> $650.00</span>
								<ul>
									<li>
										<i class="icofont-star"></i>
									</li>
					...
					<div class="col-lg-4 col-sm-6">
						<div class="main-product-item">
							<div class="product-img">
								<a href="#">
									<img src="/dental-7/assets/images/products/product-7.jpg" alt="Image">
								</a>
					...
					<div class="col-lg-4 col-sm-6">
						<div class="main-product-item">
							<div class="product-img">
								<a href="#">
									<img src="/dental-7/assets/images/products/product-8.jpg" alt="Image">
								</a>
					...
					<div class="col-lg-4 col-sm-6">
						<div class="main-product-item">
							<div class="product-img">
								<a href="#">
									<img src="/dental-7/assets/images/products/product-9.jpg" alt="Image">
								</a>
