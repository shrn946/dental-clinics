							...
							<ul class="navbar-nav m-auto">
								...
								<li class="nav-item">
									...
									<ul class="dropdown-menu">
										...
										<li class="nav-item">
											<a href="/dental-7/testimonials" class="nav-link active">Testimonials Page</a>
										</li>
										<li class="nav-item">
			...
			<div class="container">
				...
				<div class="row">
					...
					<div class="col-lg-4 col-md-6">
						<div class="main-testimonials hover-style wow fadeInUp delay-0-4s">
							<div class="inner-border">
								<img src="/dental-7/assets/images/testimonials/testimonials-5.jpg" alt="Image">
					...
					<div class="col-lg-4 col-md-6">
						<div class="main-testimonials hover-style wow fadeInUp delay-0-6s">
							<div class="inner-border">
								<img src="/dental-7/assets/images/testimonials/testimonials-6.jpg" alt="Image">
