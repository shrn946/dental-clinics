					...
					<nav class="navbar navbar-expand-md navbar-light">
						...
						<div class="collapse navbar-collapse for-mobile-menu" id="navbarSupportedContent">
							<ul class="navbar-nav m-auto">
								...
								<li class="nav-item">
									<a href="/dental-7/contact-us" class="nav-link active">Contact Us</a>
								</li>
							</ul>
		...
		<section class="contact-us-section pt-100 pb-70">
			<div class="container">
				<div class="main-section-title wow fadeInUp delay-0-2s">
					...
					<h2>Meet Us To Find Out More About Us. Hopefully You Will Know Better</h2>
				</div>
				...
				<div class="row">
					<div class="col-lg-3 col-sm-6">
						<div class="main-contact-info-item hover-style wow fadeInUp delay-0-2s">
							<div class="inner-border">
								<div class="icon">
									<img src="/dental-7/assets/images/icon/icon-17.svg" alt="Image">
								</div>
								<h3>Address</h3>
					...
					<div class="col-lg-3 col-sm-6">
						<div class="main-contact-info-item hover-style wow fadeInUp delay-0-4s">
							<div class="inner-border">
								<div class="icon">
									<img src="/dental-7/assets/images/icon/icon-18.svg" alt="Image">
								</div>
								<h3>Opening Hours</h3>
								<ul>
									<li>
					...
					<div class="col-lg-3 col-sm-6">
						<div class="main-contact-info-item hover-style wow fadeInUp delay-0-6s">
							<div class="inner-border">
								<div class="icon">
									<img src="/dental-7/assets/images/icon/icon-19.svg" alt="Image">
								</div>
								<h3>Phone Number</h3>
								<ul>
									<li>
										<a href="tel:+7-(903)-679-96-15">+7 (903) 679-96-15</a>
									</li>
									<li>
										<a href="tel:+7-(982)-444-12-64">+7 (982) 444 12 64</a>
									</li>
								</ul>
							</div>
						</div>
					...
					<div class="col-lg-3 col-sm-6">
						<div class="main-contact-info-item hover-style wow fadeInUp delay-0-8s">
							<div class="inner-border">
								<div class="icon">
									<img src="/dental-7/assets/images/icon/icon-20.svg" alt="Image">
								</div>
								<h3>Email Address</h3>
								<ul>
									<li>
					...
					<div class="col-lg-6">
						<form class="contact-form me-15 wow fadeInUp delay-0-2s">
							<div class="contact-title">
								...
								<p>Which is located in White Bear Lake, MN, offers a complete range of dental services. Dr. Daniel Isaacson and Dr. Mike Weisbrod are some.</p>
							</div>
					...
					<div class="col-lg-6">
						<div class="map-wrap ms-15 wow fadeInUp delay-0-4s">
							<div class="contact-title">
								...
								<p> An extraction may be necessary if your tooth is so damaged that it can't be fixed with a dental restoration. In some cases.</p>
							</div>

							<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d13004323.590934537!2d-104.6752891796967!3d37.27418510935136!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x54eab584e432360b%3A0x1c3bb99243deb742!2sUnited%20States!5e0!3m2!1sen!2sbd!4v1653728373058!5m2!1sen!2sbd"></iframe>
						</div>
					</div>
				</div>
			</div>
