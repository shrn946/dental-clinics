							...
							<ul class="navbar-nav m-auto">
								...
								<li class="nav-item">
									...
									<ul class="dropdown-menu">
										...
										<li class="nav-item">
											<a href="/dental-7/doctors" class="nav-link active">Doctors Page</a>
										</li>
										<li class="nav-item">
				...
				<div class="row justify-content-center">
					...
					<div class="col-lg-4 col-sm-6">
						<div class="main-doctors-item hover-style wow fadeInUp delay-0-2s">
							<div class="inner-border">
								<div class="doctor-img">
									<img src="/dental-7/assets/images/doctors/doctor-4.jpg" alt="Image">
					...
					<div class="col-lg-4 col-sm-6">
						<div class="main-doctors-item hover-style wow fadeInUp delay-0-4s">
							<div class="inner-border">
								<div class="doctor-img">
									<img src="/dental-7/assets/images/doctors/doctor-5.jpg" alt="Image">
					...
					<div class="col-lg-4 col-sm-6">
						<div class="main-doctors-item hover-style wow fadeInUp delay-0-6s">
							<div class="inner-border">
								<div class="doctor-img">
									<img src="/dental-7/assets/images/doctors/doctor-6.jpg" alt="Image">
