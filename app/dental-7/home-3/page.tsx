							...
							<ul class="navbar-nav m-auto">
								<li class="nav-item">
									...
									<ul class="dropdown-menu">
										...
										<li class="nav-item">
											<a href="/dental-7/home-3" class="nav-link active">Home Page Three</a>
										</li>
										<li class="nav-item">
				...
				<div class="row align-items-center">
						...
						<div class="banner-slider-content owl-carousel owl-theme">
							<div class="banner-content style-two">
								...
								<div class="banner-btn">
									...
									<a href="/dental-7/contact-us" class="main-btn">
					...
					<div class="col-lg-6 p-0">
						<div class="banner-slider owl-carousel owl-theme">
							...
							<div class="banner-img">
								<img src="/dental-7/assets/images/banner/banner-img-2.png" alt="Image">
							</div>
							<div class="banner-img">
								<img src="/dental-7/assets/images/banner/banner-img-3.png" alt="Image">
							</div>
						</div>
					</div>
				</div>
