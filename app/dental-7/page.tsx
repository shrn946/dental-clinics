							...
							<ul class="navbar-nav m-auto">
								<li class="nav-item">
									...
									<ul class="dropdown-menu">
										<li class="nav-item">
											<a href="/dental-7" class="nav-link active">Home Page One</a>
										</li>
										<li class="nav-item">
				...
				<div class="row">
					<div class="col-lg-6">
						<div class="banner-content pt-100">
							<h1 class="wow fadeInUp delay-0-2s">WELCOME TO TOOTHST CENTER</h1>
							<p class="wow fadeInUp delay-0-4s">The history of dentistry is almost as ancient as the history of humanity and civilization with the earliest evidence dating from 7000 BC to 5500 BC Skeletal remains</p>
							...
							<h3 class="wow fadeInUp delay-0-8s">Make an Appointment</h3>
								...
								<div class="row align-items-center">
									<div class="col-lg-9">
										<div class="row">
											...
											<div class="col-lg-4 col-sm-6">
												<div class="form-floating form-group">
													<input type="text" class="form-control" id="phone" placeholder="Phone" value="" required="">
											...
											<div class="col-lg-4 col-sm-6">
												<div class="form-group">
													<input type="text" class="form-control" placeholder="04/01/2022">
												</div>
											</div>
											<div class="col-lg-4 col-sm-6">
												<div class="form-group">
							...
							<div class="banner-shape-2 shape">
								<img src="/dental-7/assets/images/banner/banner-shape-2.png" alt="Image">
							</div>
						</div>
					</div>
					...
					<div class="col-lg-6 p-0">
						<div class="banner-img wow fadeInUp delay-0-2s">
							<img src="/dental-7/assets/images/banner/banner-img.png" alt="Image">
						</div>
					</div>
				</div>
			</div>
							...
							<form class="appointment-form">
								<div class="row">
									<div class="col-lg-6 col-sm-6">
										<div class="form-floating form-group">
											<input type="text" class="form-control" id="patientNames" placeholder="Patient Name" value="" required="">
											<label for="patientNames" class="form-label">Patient Name</label>
											<div class="invalid-feedback"> Valid patient name is required.</div>
										</div>
									</div>
									<div class="col-lg-6 col-sm-6">
