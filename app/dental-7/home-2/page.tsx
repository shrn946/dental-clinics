							...
							<ul class="navbar-nav m-auto">
								<li class="nav-item">
									...
									<ul class="dropdown-menu">
										...
										<li class="nav-item">
											<a href="/dental-7/home-2" class="nav-link active">Home Page Two</a>
										</li>
										<li class="nav-item">
						...
						<div class="row">
							<div class="col-lg-6">
								<div class="banner-content style-three">
									<h1 class="wow fadeInUp" data-wow-delay=".6s">EXCEPTIONAL MEDICAL HEALTHCARE</h1>
									<p class="wow fadeInUp" data-wow-delay=".8s">Lorem ipsum dolor sit amet consectetur adipisicing elit. Quibusdam ad, adipisci fugiat maiores earum voluptatibus temporibus, optio libero.</p>
		
									<div class="banner-btn wow fadeInUp" data-wow-delay=".9s">
										<a href="/dental-7/appointment" class="main-btn">
											<span>Appointment</span>
										</a>
										<a href="/dental-7/contact-us" class="main-btn active">
							...
							<div class="col-lg-6">
								<div class="banner-img-three wow fadeInUp" data-wow-delay=".9s">
									<img src="/dental-7/assets/images/banner/banner-img-4.png" alt="Image">
								</div>
							</div>
						</div>
					</div>
