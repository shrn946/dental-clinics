							...
							<ul class="navbar-nav m-auto">
								...
								<li class="nav-item">
									...
									<ul class="dropdown-menu">
										...
										<li class="nav-item">
											<a href="/dental-7/pricing-plan" class="nav-link active">Pricing Plan Page</a>
										</li>
										<li class="nav-item">
											<a href="/dental-7/single-services" class="nav-link">Single Services Page</a>
										</li>
			...
			<div class="container">
				<div class="page-banner-content">
					...
					<ul>
						...
						<li>
							<span class="active">Pricing Plan</span>
						</li>
					</ul>
				</div>
			</div>
		...
		<section id="pricing" class="pricing-area pt-100 pb-70">
            <div class="container">
				<div class="main-section-title">
					<span class="up-title">Pricing</span>
					<h2>Choose The Pricing Plans</h2>
				</div>

                <div class="row">
					<div class="col-lg-4 col-sm-6">
						<div class="main-pricing-table left-align">
							<div class="pricing-header">
								<h3>Basic Plan</h3>
							</div>

							<div class="price">
								<sup>$</sup>49.99<sub>/ Monthly</sub>
							</div>
							...
							<ul class="pricing-features">
								...
								<li>
									<i class="close icofont-close-circled"></i>
