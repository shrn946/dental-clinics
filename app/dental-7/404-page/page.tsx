							...
							<ul class="navbar-nav m-auto">
								...
								<li class="nav-item">
									...
									<ul class="dropdown-menu">
										...
										<li class="nav-item">
											<a href="/dental-7/404-page" class="nav-link active">Error Page</a>
										</li>
									</ul>
								</li>
		...
		<div class="error-section ptb-100">
			<div class="container">
				<div class="error-content">
					<img src="/dental-7/assets/images/404.jpg" alt="Image">
					<h3>Oops! Page Not Found.</h3>
					<p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Velit neque sapiente vel eaque itaque autem ipsam illo eveniet! Error molestiae culpa nisi cumque impedit accusamus accusantium hic dicta iure modi.</p>

					<a href="/dental-7" class="main-btn">
