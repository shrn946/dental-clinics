  ...
  return (
    <div dangerouslySetInnerHTML={{ __html: `
					...
					<nav class="navbar navbar-expand-md navbar-light">
						...
						<div class="collapse navbar-collapse for-mobile-menu" id="navbarSupportedContent">
							<ul class="navbar-nav m-auto">
								...
								<li class="nav-item">
									<a href="/dental-7/about-us" class="nav-link active">About Us</a>
								</li>
		...
		<section class="our-quality-area pb-70">
				...
				<div class="row justify-content-center">
					<div class="col-lg-3 col-sm-6">
						<div class="main-quality-item hover-style">
							<div class="inner-border">
								<div class="icon">
									<img src="/dental-7/assets/images/icon/icon-13.svg" alt="Image">
								</div>
								<h3>Healthcare</h3>
					...
					<div class="col-lg-3 col-sm-6">
						<div class="main-quality-item hover-style">
							<div class="inner-border">
								<div class="icon">
									<img src="/dental-7/assets/images/icon/icon-14.svg" alt="Image">
								</div>
								<h3>Doctors</h3>
								<p>Achieving healthy teeth takes a lifetime of care. Even if you’ve been told that you have nice.</p>
							</div>
					...
					<div class="col-lg-3 col-sm-6">
						<div class="main-quality-item hover-style">
							<div class="inner-border">
								<div class="icon">
									<img src="/dental-7/assets/images/icon/icon-15.svg" alt="Image">
								</div>
								<h3>Nursing Staff</h3>
								<p>Achieving healthy teeth takes a lifetime of care. Even if you’ve been told that you have nice.</p>
							</div>
					...
					<div class="col-lg-3 col-sm-6">
						<div class="main-quality-item hover-style">
							<div class="inner-border">
								<div class="icon">
									<img src="/dental-7/assets/images/icon/icon-16.svg" alt="Image">
								</div>
								<h3>Facilities</h3>
								<p>Achieving healthy teeth takes a lifetime of care. Even if you’ve been told that you have nice.</p>
							</div>
			...
			<img src="/dental-7/assets/images/quality-shape-1.png" class="shape shape-1" alt="Image">
			<img src="/dental-7/assets/images/quality-shape-2.png" class="shape shape-2" alt="Image">
		</section>
