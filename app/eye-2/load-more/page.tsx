...
<div class="sub_banner position-relative">
                        ...
                        <li class="nav-item dropdown active">
                            ...
                            <div class="dropdown-menu drop-down-content">
                                <ul class="list-unstyled drop-down-pages">
                                    ...
                                    <li class="nav-item active"><a class="dropdown-item nav-link" href="/eye-2/load-more">Load More</a></li>
            ...
            <div class="row">
                <div class="col-xl-6 col-lg-8 col-md-12 col-12">
                    <div class="sub_banner_content" data-aos="fade-up">
                        <h1 class="text-white">Load More</h1>
                        ...
                        <div class="box">
                            ...
                            <span class="mb-0 box_span">Load More</span>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="blog-posts blogpage-section loadblog-section background-gradient">
        <div class="container">
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-4 col-lg-4">
                            <div class="blog-box load-blog float-left w-100 post-item mb-4 hide-blog" data-aos="fade-up"
                                ...
                                <div class="post-item-wrap position-relative">
                                    <div class="post-image">
                                        <a href="#"><img alt="image" src="/eye-2/assets/images/standard_post_img03.jpg"
                                                loading="lazy"> </a>
                                    </div>
                                    <div class="lower-portion">
                                        <div class="span-i-con">
                                    ...
                                    <div class="blog-box load-blog hide-blog" data-aos="fade-up"
                                        ...
                                        <div class="post-item-wrap position-relative">
                                            <div class="post-audio position-relative">
                                                <a href="#"><img src="/eye-2/assets/images/blog-image4.jpg" alt="image"
