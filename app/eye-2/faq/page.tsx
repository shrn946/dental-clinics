                        ...
                        <li class="nav-item dropdown active">
                            ...
                            <div class="dropdown-menu drop-down-content">
                                <ul class="list-unstyled drop-down-pages">
                                    ...
                                    <li class="nav-item active"><a class="dropdown-item nav-link" href="/eye-2/faq">Faq's</a></li>
            ...
            <div class="row">
                <div class="col-xl-6 col-lg-8 col-md-12 col-12">
                    <div class="sub_banner_content" data-aos="fade-up">
                        ...
                        <p class="text-white text-size-18">Zuis nostrud exercitation ullamco laboris nisi aut aliquio modo consenuar irure in reprehenderit esse.</p>
                        <div class="box">
                            <a href="/eye-2" class="text-decoration-none">
                                <span class="mb-0">Home</span>
                            </a>
                            <i class="arrow fa-solid fa-arrow-right"></i>
                            <span class="mb-0 box_span">Faq's</span>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="row align-items-center">
            <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
                <div class="contact_wrapper position-relative">
                    <figure class="contact-image mb-0" data-aos="fade-up">
...
<!-- Team -->
<section class="team-con faqteam-con position-relative">
