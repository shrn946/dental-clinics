...
<div class="home1_banner_outer position-relative">
                        ...
                        <li class="nav-item dropdown active">
                            ...
                            <div class="dropdown-menu drop-down-content">
                                <ul class="list-unstyled drop-down-pages">
                                    <li class="nav-item active"><a class="dropdown-item nav-link" href="/eye-2">Home 1</a></li>
    ...
    <section class="banner-con position-relative">
        <figure class="banner-leftimage mb-0">
            <img src="/eye-2/assets/images/banner-leftimage.png" alt="image" class="img-fluid">
        </figure>
        <div class="container">
            <div class="row">
                <div class="col-lg-6 col-md-12 col-sm-12 col-12">
                    <div class="banner_content" data-aos="fade-up">
                        ...
                        <h1 class="text-white">Obtain Eye Care Solutions From Specialists</h1>
                        <p class="text-white text-size-18">Discover tailored eye care solutions from experienced specialists dedicated 
                            to enhancing your vision and overall eye health.
                        </p>
                ...
                <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
                    <div class="banner_wrapper position-relative">
                        <figure class="banner-rightbackground mb-0">
                            <img src="/eye-2/assets/images/banner-rightbackground.jpg" alt="image" class="img-fluid">
                        </figure>
                    </div>
                </div>
            </div>
                ...
                <div class="col-1 mx-auto">
                    <a href="#dropdown" class="top-btn text-center">
                        <figure class="banner-dropdownimage mb-0">
                            <img src="/eye-2/assets/images/banner-dropdownimage.png" class="img-fluid" alt="image">
                        </figure>
                    </a>
                </div>
            </div>
            ...
            <div class="col-xl-7 col-lg-6 col-12 text-lg-left text-center">
                <div class="about_wrapper position-relative" data-aos="fade-up">
                    <figure class="about-image1 mb-0">
                        <img src="/eye-2/assets/images/about-image1.jpg" alt="image" class="img-fluid">
                    </figure>
                    <div class="video-image">
                        <figure class="about-image2 mb-0">
                            <img src="/eye-2/assets/images/about-image2.jpg" alt="image" class="img-fluid">
                        </figure>
                        <div class="icon">
                            <a class="popup-vimeo" href="/eye-2/assets/video/video_preview_h264.mp4">
                                <div class="mb-0 video-icon">
                                    <img class="thumb img-fluid" style="cursor: pointer" src="/eye-2/assets/images/about-playicon.png" alt="image">                                    
                                </div>
                            </a>
                        </div>
                    </div>
...
<section class="choose-con position-relative">
    ...
    <figure class="choose-rightbottomimage image mb-0">
        <img src="/eye-2/assets/images/choose-rightbottomimage.png" alt="image">
    </figure>
    <div class="container">
        <div class="row">
            <div class="col-lg-4 col-12 order-lg-1 order-1">
                <div class="choose_content" data-aos="fade-up">
                    <h6>Why Choose Us</h6>
                    <h2 class="mb-0 text-white">Your Vision has Been Our Focus for More Than <span>30+</span> Years.</h2>
                </div>
            </div>
            <div class="col-lg-6 col-12 order-lg-2 order-3">
                <div class="choose_wrapper position-relative" data-aos="fade-up">
                    <figure class="choose-image mb-0">
                        <img src="/eye-2/assets/images/choose-image.png" alt="image">
                    </figure>
                </div>
            </div>
            ...
            <div class="col-lg-4 col-md-12 col-12">
                <div class="timing_content" data-aos="fade-up">
                    <figure class="specialist-intro-clockimage">
                        <img src="/eye-2/assets/images/specialist-intro-clockimage.png" class="img-fluid" alt="image">
                    </figure>
                    <h5>Opening Hours</h5>
                    <ul class="list-unstyled mb-0">
                        <li>
                ...
                <div class="intro_content" data-aos="fade-up">
                    <div class="image position-relative">
                        <figure class="specialist-intro-image mb-0">
                            <img src="/eye-2/assets/images/specialist-intro-image.jpg" class="img-fluid" alt="image">
                        </figure>
                        <figure class="specialist-intro-quoteimage mb-0">
                            <img src="/eye-2/assets/images/specialist-intro-quoteimage.png" class="img-fluid" alt="image">
                        </figure>
                    </div>
                    <div class="content">
                        <h6>specialist</h6>
                        <h3>Premier Lasik Vision!</h3>
                        <p>“Dr. James Anderson is devoted to ensuring his patients receive the best care possible. We at MediCare are focused on your well-being.”</p>
                        <div class="lower_detail">
                            ...
                            <figure class="specialist-intro-signature mb-0">
                                <img src="/eye-2/assets/images/specialist-intro-signature.png" class="img-fluid" alt="image">
                            </figure>
                        </div>
                    </div>
                </div>
        ...
        <div class="row">
            <div class="col-lg-10 col-md-12 col-12 mx-auto">
                <div class="help_content text-center" data-aos="fade-up">
                    <h6>Need Help?</h6>
                    <h2 class="text-white">Looking for a Check-up?<br> Call Us for Emergency Support!</h2>
                    <div class="phone-number">
                        <img src="/eye-2/assets/images/help-phoneimage.png" alt="image" class="img-fluid">
                        <a href="tel:+568925896325" class="text-decoration-none">
                            <span class="number">+5689 2589 6325</span>
                        </a>
                    </div>
...
<section class="team-con position-relative">
    <figure class="team-leftimage mb-0">
        <img src="/eye-2/assets/images/team-leftimage.png" alt="image" class="img-fluid">
    </figure>
    <div class="container">
        <div class="row">
            <div class="col-12">
        ...
        <div class="row" data-aos="fade-up">
            <div class="col-lg-4 col-md-4 col-sm-6 col-12 mx-auto">
                <div class="team-box">
                    <figure class="team-image">
                        <img src="/eye-2/assets/images/team-image1.jpg" alt="image" class="img-fluid">
                    </figure>
                    <div class="content">
                        <h4>Marvin Joner</h4>
            ...
            <div class="col-lg-4 col-md-4 col-sm-6 col-12 mx-auto">
                <div class="team-box">
                    <figure class="team-image">
                        <img src="/eye-2/assets/images/team-image2.jpg" alt="image" class="img-fluid">
                    </figure>
                    <div class="content">
            ...
            <div class="col-lg-4 col-md-4 col-sm-6 col-12 mx-auto">
                <div class="team-box mb-0">
                    <figure class="team-image">
                        <img src="/eye-2/assets/images/team-image3.jpg" alt="image" class="img-fluid">
                    </figure>
                    <div class="content">
                        <h4>Hannaz Stone</h4>
...
<section class="contact-con position-relative">
    <figure class="contact-rightimage mb-0">
        <img src="/eye-2/assets/images/contact-rightimage.png" alt="image" class="img-fluid">
    </figure>
    <div class="container">
        <div class="row">
            <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
                <div class="contact_wrapper position-relative">
                    <figure class="contact-leftbackground mb-0">
                        <img src="/eye-2/assets/images/contact-leftbackground.jpg" alt="image" class="img-fluid">
                    </figure>
                </div>
            </div>
            <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
