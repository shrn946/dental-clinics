                        ...
                        <li class="nav-item dropdown active">
                            ...
                            <div class="dropdown-menu drop-down-content">
                                <ul class="list-unstyled drop-down-pages">
                                    ...
                                    <li class="nav-item active"><a class="dropdown-item nav-link" href="/eye-2/three-column">Three Column</a></li>
                    ...
                    <div class="row">
                        <div class="col-lg-4 col-md-6 col-sm-6 col-12" data-aos="fade-up" data-aos-duration="700">
                            <div class="blog-box blog-box1">
                                <figure class="blog-image mb-0">
                                    <img src="/eye-2/assets/images/blog-image1.jpg" alt="image" class="img-fluid" loading="lazy">
                                </figure>
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-6 col-12" data-aos="fade-up" data-aos-duration="700">
                            <div class="blog-box blog-box2">
                                <figure class="blog-image mb-0">
                                    <img src="/eye-2/assets/images/blog-image2.jpg" alt="image" class="img-fluid" loading="lazy">
                                </figure>
                                <div class="lower-portion">
                                    <div class="span-i-con">
                                    <i class="fa-solid fa-user"></i>
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-6 col-12" data-aos="fade-up" data-aos-duration="700">
                            <div class="blog-box">
                                <figure class="blog-image mb-0">
                                    <img src="/eye-2/assets/images/blog-image3.jpg" alt="image" class="img-fluid" loading="lazy">
                                </figure>
                                <div class="lower-portion">
                                    <div class="span-i-con">
                                    <i class="fa-solid fa-user"></i>
                            ...
                            <div class="blog-box">
                                <div class="post-item-wrap position-relative">
                                    <div class="post-audio position-relative">
                                        <a href="#"><img src="/eye-2/assets/images/blog-image4.jpg" alt="image" class="img-fluid"
                                                loading="lazy"></a>
