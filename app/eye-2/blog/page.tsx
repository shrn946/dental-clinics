                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown active">
                            ...
                            <div class="dropdown-menu drop-down-content">
                                <ul class="list-unstyled drop-down-pages">
                                    <li class="nav-item active"><a class="dropdown-item nav-link" href="/eye-2/blog">Blog</a></li>
                    ...
                    <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                        <div class="single-blog-outer-con">
                            <div class="single-blog-box">
                                <figure class="mb-0">
                                    <img src="/eye-2/assets/images/single-blog-tab-img1.jpg" alt="single-blog-tab-img1"
                                ...
                                <div class="single-blog-details">
                                    ...
                                    <h4><a href="/eye-2/single-blog">Our strength, Your Business</a></h4>
                                    ...
                                    <div class="generic-btn2">
                                        <a href="/eye-2/single-blog">Read More</a>
                                    </div>
                                </div>
                            </div>
                            <div class="single-blog-box">
                                <figure class="mb-0">
                                    <img src="/eye-2/assets/images/single-blog-tab-img2.jpg" alt="single-blog-tab-img2"
                                        loading="lazy" class="img-fluid">
                                </figure>
                                <div class="single-blog-details">
                                    <ul class="list-unstyled">
                                    ...
                                    <h4><a href="/eye-2/single-blog">How’s the Economy?</a></h4>
                                    <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod. Lorem
                                        ipsum dolor sit amet, consectetur</p>
                                    <div class="generic-btn2">
                                        <a href="/eye-2/single-blog">Read More</a>
                            ...
                            <div class="single-blog-box">
                                <figure class="mb-0">
                                    <img src="/eye-2/assets/images/single-blog-tab-img3.jpg" alt="single-blog-tab-img3"
                                        loading="lazy" class="img-fluid">
                                </figure>
                                <div class="single-blog-details">
                                    <ul class="list-unstyled">
                            ...
                            <div class="single-blog-box">
                                <figure class="mb-0">
                                    <img src="/eye-2/assets/images/single-blog-tab-img4.jpg" alt="single-blog-tab-img4"
                                        loading="lazy" class="img-fluid">
                                </figure>
                                <div class="single-blog-details">
                                    <ul class="list-unstyled">
                            ...
                            <div class="single-blog-box">
                                <figure class="mb-0">
                                    <img src="/eye-2/assets/images/single-blog-tab-img5.jpg" alt="single-blog-tab-img5"
                                        loading="lazy" class="img-fluid">
                                </figure>
                                <div class="single-blog-details">
                                    <ul class="list-unstyled">
                            ...
                            <div class="single-blog-box">
                                <figure class="mb-0">
                                    <img src="/eye-2/assets/images/single-blog-tab-img6.jpg" alt="single-blog-tab-img6"
                                        loading="lazy" class="img-fluid">
                                </figure>
                                <div class="single-blog-details">
                                    <ul class="list-unstyled">
                            ...
                            <div class="single-blog-box">
                                <figure class="mb-0">
                                    <img src="/eye-2/assets/images/single-blog-tab-img7.jpg" alt="single-blog-tab-img7"
                                        loading="lazy" class="img-fluid">
                                </figure>
                                <div class="single-blog-details">
                                    <ul class="list-unstyled">
                            ...
                            <div class="single-blog-box">
                                <figure class="mb-0">
                                    <img src="/eye-2/assets/images/single-blog-tab-img8.jpg" alt="single-blog-tab-img8"
                                        loading="lazy" class="img-fluid">
                                </figure>
                                <div class="single-blog-details">
                                    <ul class="list-unstyled">
                            ...
                            <div class="single-blog-box">
                                <figure class="mb-0">
                                    <img src="/eye-2/assets/images/single-blog-tab-img9.jpg" alt="single-blog-tab-img9"
                                        loading="lazy" class="img-fluid">
                                </figure>
                                <div class="single-blog-details">
                                    <ul class="list-unstyled">
                            ...
                            <div class="single-blog-box">
                                <figure class="mb-0">
                                    <img src="/eye-2/assets/images/single-blog-tab-img10.jpg" alt="single-blog-tab-img10"
                                        loading="lazy" class="img-fluid">
                                </figure>
                                <div class="single-blog-details">
                                    <ul class="list-unstyled">
