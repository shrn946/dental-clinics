                        ...
                        <li class="nav-item dropdown active">
                            ...
                            <div class="dropdown-menu drop-down-content">
                                <ul class="list-unstyled drop-down-pages">
                                    ...
                                    <li class="nav-item active"><a class="dropdown-item nav-link" href="/eye-2/four-column">Four Column</a></li>
            ...
            <div class="row">
                <div class="col-xl-6 col-lg-8 col-md-12 col-12">
                    <div class="sub_banner_content" data-aos="fade-up">
                        <h1 class="text-white">Four Column</h1>
                        ...
                        <div class="box">
                            ...
                            <span class="mb-0 box_span">Four Column</span>
                        </div>
                    </div>
                </div>
            </div>
                                    ...
                                    <div id="blogslider" class="carousel slide" data-ride="carousel">
                                        <div class="carousel-inner">
                                            <div class="carousel-item">
                                                <img src="/eye-2/assets/images/standard_post_img06.jpg" alt="image" loading="lazy"
                                                    class="img-fluid">
                                                <!--carousel-item-->
                                            </div>
                                            <div class="carousel-item active">
                                                <img src="/eye-2/assets/images/standard_post_img05.jpg" alt="image" loading="lazy"
                                                    class="img-fluid">
                                                <!--carousel-item-->
                                            </div>
                                            <div class="carousel-item">
                        ...
                        <div class="col-xl-3 col-lg-6 col-md-6">
                            <div class="blog-box fourcolumn-blog float-left w-100 post-item mb-4" data-aos="fade-up"
                                ...
                                <div class="post-item-wrap position-relative">
                                    <div class="post-image">
                                        <a href="/eye-2/single-blog">
                                            <img alt="image" src="/eye-2/assets/images/standard_post_img02.jpg" loading="lazy"
                                                class="img-fluid"> </a>
                                        <!--post-image-->
                                    </div>
                                    <div class="lower-portion">
                            ...
                            <div class="blog-box fourcolumn-blog float-left w-100 post-item mb-4" data-aos="fade-up"
                                ...
                                <div class="post-item-wrap position-relative">
                                    <!-- <div class="post-audio position-relative">
                                        <a href="/eye-2/single-blog">
                                            <img src="/eye-2/assets/images/standard_post_img03.jpg" alt="image" class="img-fluid"
                                                loading="lazy">
                                        </a>
                                    ...
                                    <div class="post-audio position-relative">
                                        <div class="post-image">
                                            <a href="/eye-2/single-blog">
                                                <img alt="image" src="/eye-2/assets/images/standard_post_img03.jpg"
                                                    loading="lazy">
                                            </a>
                                            <!--post-image-->
                                        </div>
                        ...
                        <div class="col-xl-3 col-lg-6 col-md-6">
                            <div class="blog-box fourcolumn-blog float-left w-100 post-item mb-4" data-aos="fade-up"
                                ...
                                <div class="post-item-wrap position-relative">
                                    <div class="post-image">
                                        <a href="/eye-2/single-blog">
                                            <img alt="image" src="/eye-2/assets/images/standard_post_img06.jpg" loading="lazy"
                                                class="img-fluid"> </a>
                                        <!--post-image-->
                                    </div>
                                    <div class="lower-portion">
