                        ...
                        <li class="nav-item dropdown active">
                            ...
                            <div class="dropdown-menu drop-down-content">
                                <ul class="list-unstyled drop-down-pages">
                                    ...
                                    <li class="nav-item active"><a class="dropdown-item nav-link" href="/eye-2/case-studies">Case Studies</a></li>
            ...
            <div class="row">
                <div class="col-xl-6 col-lg-8 col-md-12 col-12">
                    <div class="sub_banner_content" data-aos="fade-up">
                        ...
                        <p class="text-white text-size-18">Tuis nostrud exercitation ullamco laboris nisi aut aliquio modo consenuar irure in reprehenderit esse.</p>
                        <div class="box">
                            <a href="/eye-2" class="text-decoration-none">
                                <span class="mb-0">Home</span>
                            </a>
                            <i class="arrow fa-solid fa-arrow-right"></i>
                            <span class="mb-0 box_span">Case Studies</span>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="container">
        ...
        <div class="row" data-aos="fade-up">
            ...
            <div class="col-lg-4 col-md-6 col-sm-12 col-12 mx-auto">
                <div class="case-box">
                    <figure class="case-image mb-0">
                        <img src="/eye-2/assets/images/case-image4.jpg" alt="image" class="img-fluid">
                    </figure>
                    <div class="content">
                        <div class="text">
                            <h5>Drooping Eyelids</h5>
                            <p class="text-size-16 mb-0">Gulla pariatur maiores...</p>
                        </div>
            ...
            <div class="col-lg-4 col-md-6 col-sm-12 col-12 mx-auto">
                <div class="case-box">
                    <figure class="case-image mb-0">
                        <img src="/eye-2/assets/images/case-image5.jpg" alt="image" class="img-fluid">
                    </figure>
                    <div class="content">
                        <div class="text">
                            <h5>Asymmetrical</h5>
                            <p class="text-size-16 mb-0">Tulla pariatur maiores...</p>
                        </div>
            ...
            <div class="col-lg-4 col-md-6 col-sm-12 col-12 mx-auto">
                <div class="case-box">
                    <figure class="case-image mb-0">
                        <img src="/eye-2/assets/images/case-image6.jpg" alt="image" class="img-fluid">
                    </figure>
                    <div class="content">
                        <div class="text">
                            <h5>Eye Surgery</h5>
                            <p class="text-size-16 mb-0">Rulla pariatur maiores...</p>
                        </div>
