                        ...
                        <li class="nav-item dropdown active">
                            ...
                            <div class="dropdown-menu drop-down-content">
                                <ul class="list-unstyled drop-down-pages">
                                    ...
                                    <li class="nav-item active"><a class="dropdown-item nav-link" href="/eye-2/two-column">Two Column</a></li>
            ...
            <div class="row">
                <div class="col-xl-6 col-lg-8 col-md-12 col-12">
                    <div class="sub_banner_content" data-aos="fade-up">
                        <h1 class="text-white">Two Column</h1>
                        ...
                        <div class="box">
                            ...
                            <span class="mb-0 box_span">Two Column</span>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="row">
                            ...
                            <div class="blog-box twocolumn-blog float-left w-100 post-item mb-4">
                                <div class="post-item-wrap position-relative">
                                    <div class="post-image">
                                        <a href="#">
                                            <img alt="image" src="/eye-2/assets/images/post-featured.jpg" loading="lazy">
                                        </a>
                                    </div>
                                    ...
                                    <div id="blogslider" class="carousel slide" data-ride="carousel">
                                        <div class="carousel-inner">
                                            ...
                                            <div class="carousel-item active">
                                                <img src="/eye-2/assets/images/post-featured.jpg" alt="image" loading="lazy">
                                            </div>
                                            <div class="carousel-item">
                        ...
                        <div class="col-xl-6 col-lg-6 col-md-12" data-aos="fade-up" data-aos-duration="700">
                            <div class="blog-box twocolumn-blog float-left w-100 post-item mb-4">
                                <div class="post-item-wrap position-relative">
                                    <div class="post-image">
                                        <a href="#"><img alt="image" src="/eye-2/assets/images/post-featured4.jpg"
                                                loading="lazy"></a>
                                    </div>
                                    <div class="lower-portion">
                                        <div class="span-i-con">
                            ...
                            <div class="blog-box twocolumn-blog float-left w-100 post-item mb-4">
                                <div class="post-item-wrap position-relative">
                                    <div class="post-audio position-relative">
                                        <a href="#"><img alt="image" src="/eye-2/assets/images/post-featured3.jpg"
                                                loading="lazy"></a>
