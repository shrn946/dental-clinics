            ...
            <div class="row">
                <div class="col-xl-6 col-lg-8 col-md-12 col-12">
                    <div class="sub_banner_content" data-aos="fade-up">
                        ...
                        <p class="text-white text-size-18">Duis nostrud exercitation ullamco laboris nisi aut aliquio modo consenuar irure in reprehenderit esse.</p>
                        <div class="box">
    ...
    <div class="container">
        <div class="row align-items-center">
            <div class="col-xl-7 col-lg-6 col-12 text-lg-left text-center">
                <div class="about_wrapper align-items-center position-relative" data-aos="fade-up">
                    <figure class="about-image1 image mb-0">
                        <img src="/eye-2/assets/images/aboutpage-image1.jpg" alt="image" class="img-fluid">
                    </figure>
                    <figure class="about-image2 image mb-0">
                        <img src="/eye-2/assets/images/aboutpage-image2.jpg" alt="image" class="img-fluid">
                    </figure>
                    <div class="about-box">
                        <img src="/eye-2/assets/images/aboutpage-icon.png" alt="image" class="img-fluid">
            ...
            <div class="col-xl-5 col-lg-6 col-12">
                <div class="about_content" data-aos="fade-up">
                    ...
                    <p class="text2 text-size-18">Exercitation ullamco laboris nisi aut aliquio modo cone ruat ruis aute irure dolor in reprehenderit
                        in voluptatena velit esse cillum dolore.
                    </p>
